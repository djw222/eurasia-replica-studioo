  ...
  return <section id="impressum" ref={sectionRef} className="bg-foreground py-20 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="fixed right-4 md:right-8 bottom-1/4 flex flex-col gap-3 z-40">
          <a href="https://wa.me/4917784608823" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center hover:scale-110 transition-transform shadow-lg" aria-label="WhatsApp">
